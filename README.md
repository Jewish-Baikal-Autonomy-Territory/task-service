...
A gRPC microservice for managing tasks within the **Geo Assistant App** — an application providing geofence management, task tracking, and AI-powered assistance.

This service is responsible for the full lifecycle of task entities: creation, retrieval, updating, and deletion, backed by MongoDB.