...
// 	protoc        (unknown)
// source: task/task_priority.proto
...
func (TaskPriority) Descriptor() protoreflect.EnumDescriptor {
	return file_task_task_priority_proto_enumTypes[0].Descriptor()
}

func (TaskPriority) Type() protoreflect.EnumType {
	return &file_task_task_priority_proto_enumTypes[0]
}
...
func (TaskPriority) EnumDescriptor() ([]byte, []int) {
	return file_task_task_priority_proto_rawDescGZIP(), []int{0}
}

var File_task_task_priority_proto protoreflect.FileDescriptor
...
var (
	...
	file_task_task_priority_proto_rawDescData []byte
)

func file_task_task_priority_proto_rawDescGZIP() []byte {
	file_task_task_priority_proto_rawDescOnce.Do(func() {
		file_task_task_priority_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_task_task_priority_proto_rawDesc), len(file_task_task_priority_proto_rawDesc)))
	})
	return file_task_task_priority_proto_rawDescData
}
...
func init() { file_task_task_priority_proto_init() }
func file_task_task_priority_proto_init() {
	if File_task_task_priority_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_task_task_priority_proto_rawDesc), len(file_task_task_priority_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_task_task_priority_proto_goTypes,
		DependencyIndexes: file_task_task_priority_proto_depIdxs,
		EnumInfos:         file_task_task_priority_proto_enumTypes,
	}.Build()
	File_task_task_priority_proto = out.File
	file_task_task_priority_proto_goTypes = nil
	file_task_task_priority_proto_depIdxs = nil
}
